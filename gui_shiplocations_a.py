...
Get the ships location for easy-level AI.
"""""
...
class aShipPlacementView(arcade.View):
    """
...
class DummyView(arcade.View):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        next_player_ships_placement = aShipPlacementView(player2)
