...
AI to initialize the hard-level game
"""
...
from board_window_hard import AI_window
from board_window_hard import BoardWindow
...
class aiGame_hard:
    def __init__(self, player1: Player, player2: Player):
        ...
        :param: hard-level AI in the game
    ...
    def on_turn_end(self):
        ...
        :post: Switches current player and toggles self.turn_over.
               Also announce the score for player1 and AI on scoreboard.
        """
